...
// constants
#define MAX_SUB_TOURS MAX_CITIES/2  // maximum number of sub-tours in an intermediate tour
...
#define MAX_ABCYCLES MAX_CITIES/2 // only for allocation purposes, no boundary checking assurances
#define TOUR_A 0
